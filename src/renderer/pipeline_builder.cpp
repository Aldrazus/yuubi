...
namespace yuubi {
    ...
    PipelineBuilder& PipelineBuilder::disableBlending() {
        colorBlendAttachment_.colorWriteMask = vk::ColorComponentFlagBits::eR | vk::ColorComponentFlagBits::eG |
    ...
    PipelineBuilder& PipelineBuilder::setVertexInputInfo(
        ...
        vertexInputInfo_.vertexAttributeDescriptionCount = static_cast<uint32_t>(attributeDescriptions.size());
